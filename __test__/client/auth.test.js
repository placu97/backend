...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Kimberly78',
      password: 'j2yfVkNdOihVFiB',
      email: 'Nora.Runte@gmail.com',
      name: 'Virginia McLaughlin',
      userType: 134,
      mobileNo: '(092) 903-4962',
      resetPasswordLink: {},
      loginRetryLimit: 801,
      loginReactiveTime: '2023-06-08T05:55:13.881Z',
      id: '63dd3848d1e59ff2ef00abbe'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Lura.Berge',
        'password':'Pv4f8EV_TUpo8gH',
        'email':'Cleo.Jacobi60@gmail.com',
        'name':'Rickey Corwin',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(069) 635-4004',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Cleo.Jacobi60@gmail.com', });
