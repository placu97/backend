...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Morris_Balistreri',
      password: 'C4gCEEhmaajfVVA',
      email: 'Jaden.Crooks10@hotmail.com',
      name: 'Margaret Champlin',
      userType: 528,
      mobileNo: '(250) 502-8249',
      resetPasswordLink: {},
      loginRetryLimit: 795,
      loginReactiveTime: '2023-11-19T05:16:47.663Z',
      id: '63dd3847d1e59ff2ef00ab7c'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Eryn76',
        'password':'8rMQ7Gk4fofkOyd',
        'email':'Eduardo_Ondricka@yahoo.com',
        'name':'Clarence Stroman IV',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(021) 884-5254',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Eduardo_Ondricka@yahoo.com', });
