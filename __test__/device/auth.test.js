...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Amya.Howell38',
      password: 'RHEMD8f2Z0jcKf1',
      email: 'Brooke_Marquardt42@yahoo.com',
      name: 'Thelma McGlynn I',
      userType: 216,
      mobileNo: '(872) 793-3193',
      resetPasswordLink: {},
      loginRetryLimit: 9,
      loginReactiveTime: '2023-07-11T21:46:35.255Z',
      id: '63dd3847d1e59ff2ef00ab9d'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Cody_Murphy',
        'password':'zMCrghMU6FokYme',
        'email':'Rex62@yahoo.com',
        'name':'Johnny Mertz',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(583) 731-5833',
