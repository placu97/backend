...
router.route('/client/api/v1/user/softDelete/:id').put(userController.softDeleteUser);
router.route('/client/api/v1/user/softDeleteMany').put(userController.softDeleteManyUser);
router.route('/client/api/v1/user/delete/:id').delete(userController.deleteUser);
router.route('/client/api/v1/user/deleteMany').post(userController.deleteManyUser);
...
router.route('/aaaa').post(userController.aaaa);
