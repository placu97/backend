...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'vizPsjm3g7FIfSH',
      'isDeleted':false,
      'username':'Stefanie48',
      'email':'Sigurd62@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Stefanie48' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'9MLITjWr8dgT70W',
      'isDeleted':false,
      'username':'Orland_Hudson',
      'email':'Shyanne.Ullrich28@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Orland_Hudson' }, userToBeInserted,  { upsert: true });
